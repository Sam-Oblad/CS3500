...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// <requires>
        /// This function assumes the name will be validated in SetContentsOfCell, name will never be invalid
        /// </requires>
        /// 
        ...
        /// Uses recursion to visits the dependencies of a cell. This is used to find circular dependencies
        /// </summary>
        /// <param name="start">The starting cell</param>
        /// <param name="name">The name of the current cell</param>
        /// <param name="visited">A set of cell names that have already been visited</param>
        /// <param name="changed">This is a linked list that tracks traversal order</param>
        /// <exception cref="CircularException">This exception is thrown when a circular dependency is found</exception>
